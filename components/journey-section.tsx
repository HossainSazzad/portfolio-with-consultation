...
const timeline: TimelineItem[] = [
  {
    ...
    description:
      'Building and scaling features for one of Europe’s largest e-commerce platforms, working across global product teams.',
    current: true,
  },
  {
    icon: Building2,
    ...
    location: 'USA / Remote',
    description:
      'Developed products serving thousands of restaurants, sharpening my skills in reliable, customer-facing software.',
  },
  {
    icon: Building2,
    tag: 'Previous Role',
    ...
    location: 'USA / Remote',
    description:
      'Worked on static analysis and code security tooling, deepening my foundation in systems and correctness.',
  },
  {
    icon: GraduationCap,
    tag: 'Education',
